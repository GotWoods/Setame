...
{
    public class CreateApplicationHandlerTests : Scenarios
    {
        ...
        public void Given_a_CreateApplicationHandler()
        {
            ...
            _handler = new CreateApplicationHandler(_documentSessionMock.Object, _querySessionMock.Object, _userInfoMock.Object);
        }
